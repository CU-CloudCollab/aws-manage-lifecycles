...
**_NOTE: This project is no longer maintained. It is highly recommended that you use the native [AWS Instance Scheduler](https://aws.amazon.com/solutions/implementations/instance-scheduler/) but if you still need to use this project then we recommend you fork it and maintain your own copy._**
...
* Label value formats:
  ...
  * **limit-stop:[h]**
    * _This policy is applicable only to EC2 and OpsWorks instances._
  ...
  * **cycle-daily:[on-hour]/[off-hour]**
    * _This policy is valid for EC2, OpsWorks, and RDS instances._
